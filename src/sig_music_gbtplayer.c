...
// ==== gbt_player
// Records can be at any locations (appears to be the same between GBDK and RGBDS versions)
//
// gbt_wave: ; 8 sounds
    const uint8_t sig_gbtplayer_gbt_wave[] = {0xA5,0xD7,0xC9,0xE1,0xBC,0x9A,0x76,0x31,0x0C,0xBA,0xDE,0x60,0x1B,0xCA,0x03,0x93,
