...
#define DEF_PATTERN_STR(varname, str_content) const uint8_t varname[] = str_content
...
#define DEF_PATTERN_BUF(varname, buf_content) const uint8_t varname[] = {buf_content}
