...
// 0x20
    ...
    const uint8_t sig_gbdk_0x20_GBDK_2020_400_0x20[]       = {0xE9}; // {0xE9, 0xFF, 0xFF, 0xFF};
    const uint8_t sig_gbdk_0x20_GBDK_2020_401_plus_0x20[]  = {0xE9}; // {0xE9, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x22, 0x0D, 0x20, 0xFC, 0xC9, 0xFF, 0xFF, 0xFF};
// 0x28
    const uint32_t sig_gbdk_0x28_at = 0x0028;
    const uint8_t sig_gbdk_0x20_GBDK_2020_401_plus_0x28[]  = {0x22, 0x0D, 0x20, 0xFC, 0xC9}; // {0xE9, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x22, 0x0D, 0x20, 0xFC, 0xC9, 0xFF, 0xFF, 0xFF};
...
// 0x30
    ...
    //
    const uint8_t sig_gbdk_0x30_GBDK_2020_401_plus[]  = {0x1A, 0x22, 0x13, 0x0D, 0x20, 0xFA, 0xC9};
        ...
        // const uint8_t sig_gbdk_0x30_GBDK_2020_401_plus_with_crashhandler[]  = {0x1A, 0x22, 0x13, 0x0D, 0x20, 0xFA, 0xC9, 0xFF, 0xF3, 0xC3, 0x00, 0x02, 0xFF, 0xFF, 0xFF, 0xFF};
// 0x80
...
bool check_gbdk(void) {
    ...
    if (check_pattern_addr(sig_gbdk_0x80_GBDK_4_0_0, sizeof(sig_gbdk_0x80_GBDK_4_0_0), sig_gbdk_0x80_at)) {
        ...
        if (check_pattern_addr(sig_gbdk_0x20_GBDK_2020_400_0x20, sizeof(sig_gbdk_0x20_GBDK_2020_400_0x20), sig_gbdk_0x20_at)) {
    ...
    if ((check_pattern_addr(sig_gbdk_0x20_GBDK_2020_401_plus_0x20, sizeof(sig_gbdk_0x20_GBDK_2020_401_plus_0x20), sig_gbdk_0x20_at)) &&
        (check_pattern_addr(sig_gbdk_0x20_GBDK_2020_401_plus_0x28, sizeof(sig_gbdk_0x20_GBDK_2020_401_plus_0x28), sig_gbdk_0x28_at))) {
