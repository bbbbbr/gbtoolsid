...
// UI_b.c uicolors
    ...
    const uint8_t sig_gbs_musicmanager_c_FX_ADDR_LO_3_0_0_alpha1_plus[] = {0x05,  0x04,  0x05,  0x04,  0x00,  0x10,  0x16,  0x1A,  0x20,  0x00,  0x0E,  0x0D,  0x0B,  0x07 };
...
// ==== TODO: ====
    // GBStudio 3 Official release (has some small service releases after, not worth worrying about)
...
bool check_gbstudio(void) {
    ...
    // GBStudio 3.0.0+
    if (find_pattern(sig_gbs_musicmanager_c_FX_ADDR_LO_3_0_0_alpha1_plus, sizeof(sig_gbs_musicmanager_c_FX_ADDR_LO_3_0_0_alpha1_plus)) &&
        find_pattern(sig_gbs_math_c_sinetable_3_0_0_alpha1_plus, sizeof(sig_gbs_math_c_sinetable_3_0_0_alpha1_plus))) {
        ...
        // GBStudio 3.0.0 official - 3.1.0+ uses GBDK 4.0.5 & 4.0.6 (which cannot be differentiated
            ...
            entry_add_with_version(entry, "3.0.0 - 3.1.0+");
            return true;
        }

        entry_add_with_version(entry, "3.x.x Unknown");
        return true;
    }
